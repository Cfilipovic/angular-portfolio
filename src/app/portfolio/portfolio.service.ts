...
export class PortfolioService {
  ...
  initProjects() {
    ...
    const battleconnect = {title: "Battle Connect", description: "IOBT Android Senior Project", date: "01/09/2020", languages: ["Java", "Kotlin", "XML", "Firebase", "Google Cloud Platform"], image: "./assets/portfolio/news.png", version: "1.0", url: "/battleconnect"};
